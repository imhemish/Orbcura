      ...
      CornerChild(Image.asset("assets/next.png", height: h/16,), () {},),
        ...
        Center(
          child: Column(children: [
            ...
            Image.asset("assets/bhim.png", width: MediaQuery.sizeOf(context).width/4.5,),
            SizedBox(height: h/20),
            Image.asset("assets/qr.png", height: (h*w)/2800, width: (h*w)/600,),
            ...
            Container(
              ...
              height: h/3.8,
              width: w/4.3,
              child: Center(child: Text("QR Scan", style: GoogleFonts.leagueSpartan(fontSize: 18, color: AppColors.fontColour,), textAlign: TextAlign.center,)),
            )
          ],),
        )
